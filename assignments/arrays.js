...
// ARRAY CHALLENGES USING ARRAY METHODS
...
//Stretch: creative a narrative output to Challenge 6

// var listBMWAndAudi = ""
// for (let i = 0; i < BMWAndAudi.length; i++) {
//   var listBMWAndAudi = listBMWAndAudi + BMWAndAudi[i].car_year + " " + BMWAndAudi[i].car_make + " " + BMWAndAudi[i].car_model + ", "
// }

// console.log(listBMWAndAudi);